...
<form action="" method="POST" enctype="multipart/form-data" id="form-topic-add" class="wrapper-content">
	...
	<input type="text" id="topic_title" name="topic_title" value="{$_aRequest.topic_title}" class="input-block-level" {if $bEditDisabled}readonly="readonly"{/if} /><br />
	<span class="help-block"><small>{$aLang.topic_question_create_title_notice}</small></span></p>

	
	<div class="poll-create">
		<label>{$aLang.topic_question_create_answers}:</label>
		<ul class="unstyled question-list" id="question_list">
